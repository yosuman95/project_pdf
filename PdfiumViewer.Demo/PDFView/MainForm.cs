...
namespace PdfiumViewer.Demo
{
    public partial class MainForm : Form
    {
           ...
           /* using (var form = new OpenFileDialog())
            {
                ...
                form.Title = "Open PDF File 123456";
                ...
                String curfileName = wanted_path + myfileName+".pdf";

                pdfViewer1.Document = OpenDocument(curfileName);
                renderToBitmapsToolStripMenuItem.Enabled = true;
        ...
        {
           /* pdfViewer1.DefaultPrinter = "";
            pdfViewer1.DefaultPrintMode = " ";
            pdfViewer1.Document.
           PdfiumViewer.PdfPrintSettings
